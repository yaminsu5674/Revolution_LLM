...
#include "Characters/RevolutionPlayer.h"
...
ARevolutionPlayer::ARevolutionPlayer()
{
...
void ARevolutionPlayer::NotifyControllerChanged()
{
...
void ARevolutionPlayer::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ARevolutionPlayer::Move);
...
void ARevolutionPlayer::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ARevolutionPlayer::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
